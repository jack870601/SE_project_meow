...
-- 使用者新增
insert into User (username, password, login_count, is_admin, is_active, profile,title) values (
    '鐘良軒', 'iam30cm', 0, 0, 1, "我ㄉGG有30公分","無");
insert into User (username, password, login_count, is_admin, is_active, profile,title) values (
    'milli', 'GGstinky', 0, 0, 1, "我有stinkyGG","無");
insert into User (username, password, login_count, is_admin, is_active, profile,title) values (
    'yochang', 'localsmoke', 0, 0, 1, "同學，遠端抽煙嗎？","無");
--run_post新增
